    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3"><b>EMS</b> <sup>pro</sup></div>
            </a>
            ...
            <!-- Nav Item - System Managment Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link dropdown-toggle" href="#" data-toggle="collapse" data-target="#collapseSystem"
            ...
            <!-- Nav Item - User Managment Collapse Menu -->
            <li class="nav-item">
                ...
                <div id="collapseUser" class="collapse" aria-labelledby="headingUser"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="User-border.html">Role</a>
                        <a class="collapse-item" href="User-animation.html">Permisstion</a>
                    </div>
                </div>
            </li>
